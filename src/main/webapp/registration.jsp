...
<script type="text/javascript">
   ...
   if(status == "invalidName"){
	   swal("Failes","Please Enter Name","error");
   }
   if(status == "invalidEmail"){
	   swal("Failes","Please Enter Email","error");
   }
   if(status == "invaliUpwd"){
	   swal("Failes","Please Enter Password","error");
   }
   if(status == "invalidConfirmPassword"){
	   swal("Failes","Password do not match","error");
   }
   if(status == "invalidMobile"){
	   swal("Failes","Please Enter Mobile","error");
   }
   if(status == "invalidMobileLength"){
	   swal("Failes","Mobile Number should br of 10 digit","error");
   }
